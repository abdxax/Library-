...
--
-- Host: 127.0.0.1
-- Generation Time: 07 ديسمبر 2020 الساعة 21:43
...
(1, '308', '1', '0', '20111', 0, 'done', '0000-00-00', '2020-12-07'),
...
(14, '50', '1', '-50', '1212', 50, 'deliver', '2020-12-06', '2020-12-07'),
(15, '60', '1', '-20', '2222', 20, 'deliver', '2020-12-07', '2020-12-07'),
(16, '138', '1', '-50', '2222', 50, 'done', '2020-12-07', '2020-12-07');
...
INSERT INTO `car` (`id_car`, `email`, `contact_id`, `qu`, `bill_id`, `status`) VALUES
(1, '20111', 3, 1, 0, 'wait'),
(3, '20111', 3, 3, 0, 'wait'),
(5, '20111', 2, 1, 0, 'wait'),
(6, '20111', 2, 1, 0, 'wait'),
...
(11, '20111', 4, 1, 8, 'done'),
(12, '20111', 2, 1, 9, 'done'),
(13, '20111', 2, 1, 10, 'deliver'),
(14, '0009', 3, 1, 11, 'done'),
(15, '2222', 4, 1, 12, 'wait'),
(16, '2222', 2, 1, 13, 'deliver'),
(17, '1212', 2, 1, 14, 'deliver'),
(18, '2222', 3, 1, 15, 'deliver'),
(19, '2222', 5, 1, 15, 'deliver'),
(20, '2222', 2, 1, 16, 'done'),
(21, '2222', 4, 1, 16, 'done'),
(25, '1212', 3, 1, 0, 'waiting_buy');
...
('555545', 'Abdulrahman ALJarallah', '0568508989', 'aljarallahabdulrahman@gmail.com', 1),
...
(11, '', 'da39a3ee5e6b4b0d3255bfef95601890afd80709', 2),
(13, '555545', 'd559965849921585c1849af03b7a51638700d979', 2);
...
--
ALTER TABLE `car`
  MODIFY `id_car` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
